<template>
  <div class="uk-background-muted">
    ...
    <div class="uk-height-large uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light"
      data-src="/src/assets/images/itk_hero.png" uk-img></div>
    <h1 class="uk-text-lead zweigheading">Kolleg - Informatik (Standort Hartberg)</h1>
    <QuickFacts class="zweigpadding" typ="Kolleg (Tagesform)" dauer="4 Semester (Montag - Freitag)" abschluss="Diplomprüfung" vorraussetzungen="Reifeprüfung AHS/BHS oder Lehre mit Matura oder BRP" standort="Campus Hartberg"></QuickFacts>
