<template>
    <div class="uk-grid-large padtop padleftright qldiv" uk-scrollspy="target: > div; cls: uk-animation-fade; delay: 500"
        ...
        <SmallCard class="uk-width-expand"
            ...
            uk-scrollspy-class="uk-animation-slide-bottom" azname="Mint Gütesiegel" imgsrc="/public/images/mint.jpg">
        </SmallCard>
        ...
        <SmallCard class="uk-width-expand"
            ...
            uk-scrollspy-class="uk-animation-slide-bottom" azname="Umweltzeichen" imgsrc="/public/images/umwelt.jpg">
        </SmallCard>
        <div class="separator"><hr class="uk-divider-vertical"></div>
        <SmallCard class="uk-width-expand"
            ...
            imgsrc="/public/images/erasmus.jpg">
        </SmallCard>
        <div class="separator"><hr class="uk-divider-vertical"></div>
        <SmallCard class="uk-width-expand"
            uk-tooltip="title: Die HTL Weiz wurde wiederholt mit dem Titel Innovativste Schule der Steiermark ausgezeichnet.; delay: 500"
            uk-scrollspy-class="uk-animation-slide-bottom" azname="Innovativste Schule" imgsrc="/public/images/inno.jpg">
        </SmallCard>
        <div class="separator"><hr class="uk-divider-vertical"></div>
        <SmallCard class="uk-width-expand"
            uk-tooltip="title: S-6.1b COVID-19 - Unterrichtsbezogene Förderangebote; delay: 500"
            uk-scrollspy-class="uk-animation-slide-bottom" azname="Förderangebote" imgsrc="/public/images/förder.png">
        </SmallCard>
    </div>
</template>
