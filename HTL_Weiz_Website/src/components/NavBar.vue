                ...
                <ul class="uk-navbar-nav">
                  ...
                  <li>
                    <router-link class="uk-logo" to="/">
                      <img src="/images/htl_logo.svg" width="100" />
                      <img src="/images/logo_ff.png" width="60" />
                    </router-link>
                  </li>
                        ...
                        <div class="uk-navbar-right">
                          <ul class="uk-navbar-nav">
                            <li class="navbigscreen">
                              ...
                              <div class="uk-navbar-dropdown">
                                <ul class="uk-nav uk-navbar-dropdown-nav">
                                  ...
                                  <li><a href="https://www.ttz-weiz.at/">TTZ</a></li>
                                </ul>
                              </div>
                            </li>
                            <li class="navbigscreen">
                            ...
                            <li class="navbigscreen">
                              ...
                              <div class="uk-navbar-dropdown">
                                <ul class="uk-nav uk-navbar-dropdown-nav">
                                  ...
                                  <li><a href="https://www.ttz-weiz.at/">Individuelle Kurse TTZ</a></li>
                                </ul>
                              </div>
                            </li>
                            <li class="navbigscreen">
                            ...
                            <li class="navbigscreen">
                              ...
                              <div class="uk-navbar-dropdown">
                                <ul class="uk-nav uk-navbar-dropdown-nav">
                                  <li><router-link :to="{ path: '/team', hash: '#sekretariat' }">Sekretariat</router-link></li>
                                  <li><router-link :to="{ path: '/team', hash: '#bildungsberatung' }">Bildungsberatung</router-link></li>
                                  <li><router-link :to="{ path: '/team', hash: '#mädchenbeauftragte' }">Mädchenbeauftragte</router-link></li>
                                  <li><router-link :to="{ path: '/team', hash: '#vertrauenslehrerinnen' }">VertrauenslehrerInnen</router-link></li>
                                  <li><router-link :to="{ path: '/team', hash: '#schularzt' }">Schularzt</router-link></li>
                                  <li><router-link :to="{ path: '/team', hash: '#schulpsychologe' }">Schulpsychologe</router-link></li>
                                </ul>
                              </div>
                            </li>
                          </ul>
        ...
        <ul class="uk-nav uk-nav-default" uk-accordion="multiple: true">
          <li class="navsmallscreen uk-parent uk-light">
            ...
            <div class="uk-accordion-content uk-nav-sub">
              <li><router-link to="/team">Team</router-link></li>
              <li><router-link :to="{ path: '/team', hash: '#verwaltung' }">Verwaltung</router-link></li>
              <li><router-link :to="{ path: '/team', hash: '#schülerinnenvertretung' }">SchülerInnenvertretung</router-link></li>
              <li><router-link to="/elternverein">Elternverein</router-link></li>
              <li><router-link to="/partner">Partner</router-link></li>
              <li><a href="https://www.absolventen-htlweiz.at/">Absolventenverein</a></li>
              <li><a href="https://www.ttz-weiz.at/">TTZ</a></li>
...
@media (min-width: 1075px) {
  ...
  .navsmallscreen .uk-offcanvas-bar {
