<template>
  <div class="uk-grid-large padleftright" uk-scrollspy="target: > div; cls: uk-animation-fade; delay: 200" uk-grid>
  ...
  <SmallCard class="uk-width-expand" uk-tooltip="title: S-6.1b COVID-19 - Unterrichtsbezogene Förderangebote; delay: 500" uk-scrollspy-class="uk-animation-slide-bottom" azname="Förderangebote" imgsrc="src/assets/images/förder.png"></SmallCard>
  </div>
</template>
